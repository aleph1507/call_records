...
var ConfirmationModal = /*#__PURE__*/function (_Modal) {
  ...
  function ConfirmationModal(form) {
    var _this;

    var callbackCancel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

    _classCallCheck(this, ConfirmationModal);

    _this = _super.call(this, 'confirm-modal');

    if (!callbackCancel) {
      callbackCancel = _this.close;
    }

    _this.content.querySelector('.confirm').addEventListener('click', function (confirm) {
      form.submit();
    });

    _this.content.querySelector('.cancel').addEventListener('click', function (cancel) {
      callbackCancel();
    });
...
var _require = __webpack_require__(/*! ./ConfirmationModal */ "./resources/js/ConfirmationModal.js"),
...
window.addEventListener('DOMContentLoaded', function (e) {
  ...
  var _loop = function _loop(i) {
    formConfirmables[i].addEventListener('submit', function (event) {
      event.preventDefault();
      var cm = new ConfirmationModal(formConfirmables[i]);
      cm.display();
    });
  };

  for (var i = 0; i < formConfirmables.length; i++) {
    _loop(i);
  }
});
